...
def eleccion_usuario():
    ...
    ventana1.iconbitmap(r"C:\Users\CHANIS\Downloads\istockphoto-1126396789-170667a.ico")
...
def tabla_admin():
    ...
    ventana24.iconbitmap(r"C:\Users\CHANIS\Downloads\istockphoto-1126396789-170667a.ico")
...
def elec_serv():
    ...
    if servx != servicio1 and servx != servicio2 and servx != servicio3 and servx != servicio4 and servx != servicio5 and servx != servicio6 and servx != servicio7 and servx != servicio8 and servx != servicio9 and servx != servicio10:
        ...
        str_calle = str(calle.get())
        str_namemasc = str(namemasc.get())
        conexion.execute("insert into clientes(nombre,edad,raza,masc,ubi,servi) values (?,?,?,?,?,?)",
        ...
        ventana4.iconbitmap(r"C:\Users\CHANIS\Downloads\istockphoto-1126396789-170667a.ico")
...
def servicios():
    ...
    ventana10.iconbitmap(r"C:\Users\CHANIS\Downloads\istockphoto-1126396789-170667a.ico")
...
def ubicaciones():
    def compro():
        ...
        if callex != calle1 and callex != calle2 and callex != calle3 and callex != calle4 and callex != calle5 and callex != calle6:
            ...
            ventana3.iconbitmap(r"C:\Users\CHANIS\Downloads\istockphoto-1126396789-170667a.ico")
    ...
    ventana5.iconbitmap(r"C:\Users\CHANIS\Downloads\istockphoto-1126396789-170667a.ico")
...
def login_admin():
    ...
    ventana2.iconbitmap(r"C:\Users\CHANIS\Downloads\istockphoto-1126396789-170667a.ico")
